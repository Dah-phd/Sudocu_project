...
class puzzle_board():
    ...
    def replace(self, row, column, test=0):
        ...
        if len(possible_values) > test:
            print(possible_values)
            return possible_values[test]
        else:
            return False

    def solve(self, row=0, column=0, positions=[[]], test=0):
        print(positions)
        print(row, column)
        if self.template[row][column] == 0 and test == 0:
            r = self.replace(row, column)
            if r:
                self.template[row][column] = r
                positions.append([row, column, test])
            else:
                self.template[positions[-1][0]][positions[-1][1]] = 0
                self.solve(positions[-1][0], positions[-1][1], positions, positions[-1][2]+1)
                return
        elif test != 0:
            positions.pop()
            r = self.replace(row, column, test)
            if r:
                self.template[row][column] = r
                positions.append([row, column, test])
            else:
        ...
        if row == 8 and column == 8:
            ...
            if column == 8:
                row += 1
                column = 0
                self.solve(row, column, positions)
            else:
                column += 1
                self.solve(row, column, positions)
    ...
    for t in range(9):
        for t1 in range(9):
            if template_.base[t][t1] != 0:
                ...
                entry.bind('<Return>', lambda event: enter(template_, list_entry))
...
def set(diff=1):
    ...
    def get_board(diff=2):
        ...
        try:
            ...
            if diff == 1:
                a = [{'x': 0, 'y': 0, 'value': 5}, {'x': 0, 'y': 3, 'value': 8},
                     {'x': 0, 'y': 4, 'value': 1}, {'x': 0, 'y': 8, 'value': 4},
                     {'x': 1, 'y': 1, 'value': 2}, {'x': 1, 'y': 4, 'value': 5},
                     {'x': 1, 'y': 5, 'value': 4}, {'x': 1, 'y': 6, 'value': 1},
                     {'x': 1, 'y': 7, 'value': 6}, {'x': 2, 'y': 3, 'value': 7},
                     {'x': 2, 'y': 5, 'value': 9}, {'x': 2, 'y': 8, 'value': 5},
                     {'x': 3, 'y': 2, 'value': 1}, {'x': 3, 'y': 6, 'value': 7},
                     {'x': 3, 'y': 7, 'value': 5}, {'x': 3, 'y': 8, 'value': 6},
                     {'x': 4, 'y': 0, 'value': 2}, {'x': 4, 'y': 3, 'value': 6},
                     {'x': 4, 'y': 4, 'value': 9}, {'x': 4, 'y': 5, 'value': 7},
                     {'x': 5, 'y': 0, 'value': 8}, {'x': 5, 'y': 1, 'value': 7},
                     {'x': 5, 'y': 2, 'value': 6}, {'x': 5, 'y': 5, 'value': 1},
                     {'x': 5, 'y': 6, 'value': 2}, {'x': 6, 'y': 1, 'value': 5},
                     {'x': 6, 'y': 2, 'value': 9}, {'x': 6, 'y': 3, 'value': 1},
                     {'x': 6, 'y': 5, 'value': 3}, {'x': 6, 'y': 8, 'value': 2},
                     {'x': 7, 'y': 1, 'value': 1}, {'x': 7, 'y': 3, 'value': 4},
                     {'x': 7, 'y': 6, 'value': 5}, {'x': 7, 'y': 7, 'value': 9},
                     {'x': 7, 'y': 8, 'value': 8}, {'x': 8, 'y': 0, 'value': 7},
                     {'x': 8, 'y': 1, 'value': 8}, {'x': 8, 'y': 3, 'value': 9},
                     {'x': 8, 'y': 4, 'value': 6}, {'x': 8, 'y': 7, 'value': 1},
                     {'x': 8, 'y': 8, 'value': 3}]
            elif diff == 2:
                a = [{'x': 0, 'y': 2, 'value': 6}, {'x': 0, 'y': 4, 'value': 2}, {'x': 0, 'y': 6, 'value': 3},
                     {'x': 0, 'y': 8, 'value': 1}, {'x': 1, 'y': 4, 'value': 7},
                     {'x': 1, 'y': 6, 'value': 6}, {'x': 2, 'y': 0, 'value': 5},
                     {'x': 2, 'y': 1, 'value': 1}, {'x': 2, 'y': 7, 'value': 8},
                     {'x': 3, 'y': 0, 'value': 3}, {'x': 3, 'y': 6, 'value': 7},
                     {'x': 3, 'y': 8, 'value': 8}, {'x': 4, 'y': 3, 'value': 3},
                     {'x': 4, 'y': 5, 'value': 5}, {'x': 4, 'y': 6, 'value': 1},
                     {'x': 5, 'y': 0, 'value': 8}, {'x': 5, 'y': 2, 'value': 5},
                     {'x': 5, 'y': 5, 'value': 7}, {'x': 5, 'y': 7, 'value': 3},
                     {'x': 5, 'y': 8, 'value': 9}, {'x': 6, 'y': 1, 'value': 8},
                     {'x': 6, 'y': 3, 'value': 7}, {'x': 6, 'y': 7, 'value': 1},
                     {'x': 7, 'y': 0, 'value': 9}, {'x': 7, 'y': 4, 'value': 5},
                     {'x': 7, 'y': 8, 'value': 3}, {'x': 8, 'y': 2, 'value': 2},
                     {'x': 8, 'y': 4, 'value': 3}, {'x': 8, 'y': 5, 'value': 6},
                     {'x': 8, 'y': 6, 'value': 9}]
        ...
        for t in range(5):
            lif = tk.Label(game_win, text="\U0001F600", font=("TimesNewRoman", 40), fg='green')
